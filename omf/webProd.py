...
if __name__ == "__main__":
	...
	# Start application:
	appProc = Popen(['gunicorn', '-w', '5', '-b', '0.0.0.0:443', '--certfile=omfDevCert.pem', '--keyfile=omfDevKey.pem', '--preload', 'web:app','--log-file', 'omf.error.log', '--capture-output', '--worker-class=gevent'])