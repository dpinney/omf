...
with open(pJoin(__metaModel__._myDir,"_demandResponse.html"),"r") as tempFile:
...
def run(modelDir, inputDict):
	...
	try:
		...
		modifiedLoad = applyDR(demandCurve, rates, schedule, impact_factors)
		...
		outData["ParticipationRate"] = ManagLoad * 100
