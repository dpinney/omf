...
struct s_module_list {
	...
	int (*check)();
	/* deltamode */
	unsigned int (*deltadesired)(void);
	unsigned int (*preupdate)(void*,int64,unsigned int64);
	unsigned int (*interupdate)(void*,int64,unsigned int64);
	unsigned int (*postupdate)(void*,int64,unsigned int64);
#ifndef _NO_CPPUNIT
