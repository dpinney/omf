...
######### ALL OBJECTS WE WISH TO CREATE SHOULD HAVE A STORED (KEY : VALUE) IN THIS DICTIONARY!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		glm_objects={	'node' : ['name','groupid','parent','bustype','phases','nominal_voltage','comment'],
								'meter' : ['name','groupid','parent','bustype','phases','voltage_A','voltage_B','voltage_C','nominal_voltage','comment'],
								'load' : ['name','groupid','parent','bustype','phases','nominal_voltage','load_class','constant_power_A','constant_power_B','constant_power_C','constant_current_A','constant_current_B','constant_current_C','constant_impedance_A','constant_impedance_B','constant_impedance_C','base_power_A','base_power_B','base_power_C','power_pf_A','power_pf_B','power_pf_C','current_pf_A','current_pf_B','current_pf_C','impedance_pf_A','impedance_pf_B','impedance_pf_C','power_fraction_A','power_fraction_B','power_fraction_C','current_fraction_A','current_fraction_B','current_fraction_C','impedance_fraction_A','impedance_fraction_B','impedance_fraction_C','comment'],
								'triplex_node' : ['name','groupid','parent','bustype','phases','nominal_voltage','power_12','load_class','comment'],
								'triplex_meter' : ['name','groupid','parent','bustype','phases','nominal_voltage','comment'],
								'triplex_load' : ['name','groupid','parent','bustype','phases','nominal_voltage','load_class','constant_power_1','constant_power_2','constant_power_12','constant_current_1','constant_current_2','constant_current_12','constant_impedance_1','constant_impedance_2','constant_impedance_12','base_power_1','base_power_2','base_power_12','power_pf_1','power_pf_2','power_pf_12','current_pf_1','current_pf_2','current_pf_12','impedance_pf_1','impedance_pf_2','impedance_pf_12','power_fraction_1','power_fraction_2','power_fraction_12','current_fraction_1','current_fraction_2','current_fraction_12','impedance_fraction_1','impedance_fraction_2','impedance_fraction_12','comment'],
								'capacitor' : ['name','groupid','parent','phases','nominal_voltage','pt_phase','phases_connected','switchA','switchB','switchC','control','voltage_set_high','voltage_set_low','VAr_set_high','VAr_set_low','current_set_high','current_set_low','capacitor_A','capacitor_B','capacitor_C','cap_nominal_voltage','time_delay','dwell_time','lockout_time','remote_sense','remote_sense_B','control_level','comment'],
								'fuse' : ['name','groupid','phases','from','to','phase_A_status','phase_B_status','phase_C_status','repair_dist_type','current_limit','mean_replacement_time','comment','status'],
								'switch' : ['name','groupid','phases','from','to','phase_A_state','phase_B_state','phase_C_state','operating_mode','comment'],
								'overhead_line' : ['name','groupid','phases','from','to','length','configuration','comment'],
								'underground_line' : ['name','groupid','phases','from','to','length','configuration','comment'],
								'triplex_line' : ['name','groupid','phases','from','to','length','configuration','comment'],
								'transformer' : ['name','groupid','phases','from','to','configuration','climate','aging_constant','use_thermal_model','aging_granularity','comment'],
								'regulator' : ['name','groupid','phases','from','to','configuration','sense_node','comment'],
								'line_configuration' : ['name','groupid','conductor_A','conductor_B','conductor_C','conductor_N','spacing','z11','z12','z13','z21','z22','z23','z31','z32','z33','comment'],
								'triplex_line_configuration' : ['name','groupid','conductor_1','conductor_2','conductor_N','insulation_thickness','diameter','spacing','z11','z12','z21','z22','comment'],
								'transformer_configuration' : ['name','groupid','connect_type','install_type','coolant_type','cooliing_type','primary_voltage','secondary_voltage','power_rating','powerA_rating','powerB_rating','powerC_rating','impedance','shunt_impedance','core_coil_weight','tank_fittings_weight','oil_volume','rated_winding_time_constant','rated_winding_hot_spot_rise','rated_top_oil_rise','no_load_loss','full_load_loss','reactance_resistance_ratio','installed_insulation_life','comment'],
								'regulator_configuration' : ['name','groupid','connect_type','band_center','band_width','time_delay','dwell_time','raise_taps','lower_taps','current_transducer_ratio','power_transducer_ratio','compensator_r_setting_A','compensator_x_setting_A','compensator_r_setting_B','compensator_x_setting_B','compensator_r_setting_C','compensator_x_setting_C','CT_phase','PT_phase','regulation','control_level','Control','Type','tap_pos_A','tap_pos_B','tap_pos_C','comment'],
								'line_spacing' : ['name','groupid','distance_AB','distance_AC','distance_AN','distance_AE','distance_BC','distance_BN','distance_BE','distance_CN','distance_CE','distance_NE','comment'],
								'overhead_line_conductor' : ['name','groupid','geometric_mean_radius','resistance','diameter','rating.summer.continuous','rating.summer.emergency','rating.winter.continuous','rating.winter.emergency','comment'],
								'underground_line_conductor' : ['name','groupid','outer_diameter','conductor_gmr','conductor_diameter','conductor_resistance','neutral_gmr','neutral_diameter','neutral_resistance','neutral_strands','insulation_relative_permitivitty','shield_gmr','shield_resistance','rating.summer.continuous','rating.summer.emergency','rating.winter.continuous','rating.winter.emergency','comment'],
								'triplex_line_conductor' : ['name','groupid','resistance','geometric_mean_radius','rating.summer.continuous','rating.summer.emergency','rating.winter.continuous','rating.winter.emergency','comment'],
								'climate' : ['name','groupid','temperature','tmyfile','interpolate','comment'],
								'csvreader' : ['name','groupid','filename','timefmt','timezone','comment'],
								'inverter' : ['name','groupid','parent','generator_status','generator_mode','inverter_type','four_quadrant_control_mode','coupling_inductance_type','control_mode_switch','V_In','I_In','power_factor','P_Out','Q_Out','use_multipoint_efficiency','inverter_manufacturer','maximum_dc_power','maximum_dc_voltage','minimum_dc_power','c_o','c_1','c_2','c_3','nominal_frequency','initial_inverter_frequency','PLL_measured_frequency','nominal_VRMSLG','measured_VRMSLL','coupling_L1','coupling_L2','coupling_C','constant_PQ_KPPLL','constant_PQ_KIPLL','constant_PQ_KPP','constant_PQ_KIP','constant_PQ_KPQ','constant_PQ_KIQ','constant_PQ_T_MeasP','constant_PQ_T_MeasQ','constant_PQ_T_MeasV','constant_PQ_TPRefFilter','constant_PQ_TQRefFilter','constant_PQ_vt_max_angle_ref','constant_PQ_vt_min_angle_ref','constant_PQ_vt_max_mag_ref','constant_PQ_vt_min_mag_ref','droop_PQ_KPPLL','droop_PQ_KIPLL','droop_PQ_KPP','droop_PQ_KIP','droop_PQ_KPQ','droop_PQ_KIQ','droop_PQ_T_MeasP','droop_PQ_T_MeasQ','droop_PQ_T_MeasV','droop_PQ_TPRefFilter','droop_PQ_TQRefFilter','droop_PQ_vt_max_angle_ref','droop_PQ_vt_min_angle_ref','droop_PQ_vt_max_mag_ref','droop_PQ_vt_min_mag_ref','droop_P1','droop_P2','droop_Q1','droop_Q2','droop_f1','droop_f2','droop_V1','droop_V2','islanded_state','comment'],
								'solar' : ['name','groupid','parent','generator_status','generator_mode','panel_type','power_type','INSTALLATION_TYPE','SOLAR_TILT_MODEL','SOLAR_POWER_MODEL','a_coeff','b_coeff','dT_coeff','T_coeff','NOCT','Tmodule','Tambient','wind_speed','ambient_temperature','Insolation','Rinternal','Rated_Insolation','Pmax_temp_coeff','Voc_temp_coeff','V_Max','Voc_Max','Voc','efficiency','area','soiling','derating','Rated_kVA','weather','shading_factor','tilt_angle','orientation_azimuth','latitude_angle_fix','orientation','phases','comment'],
								'auction' : ['name','groupid','type','unit','period','latency','market_id','price_cap','special_mode','statistic_mode','fixed_price','fixed_quantity','capacity_reference_object','capacity_reference_property','capacity_reference_bid_price','capacity_reference_bid_quantity','max_capacity_reference_bid_quantity','init_price','init_stdev','future_mean_price','use_future_mean_price','margin_mode','warmup','transaction_log_file','curve_log_file','curve_log_info','comment'],
								...
								'waterheater' : ['name','groupid','parent','heat_mode','location','tank_volume','tank_UA','tank_diameter','water_demand','heating_element_capacity','inlet_water_temperature','tank_setpoint','thermostat_deadband','temperature','height','demand','actual_load','previous_load','actual_power','is_waterheater_on','gas_fan_power','gas_standby_power','comment'],
								'player' : ['name','groupid','parent','property','file','loop','flags','comment'],
								'recorder' : ['name','groupid','parent','property','file','trigger','interval','limit','comment'],
								'multi_recorder' : ['name','groupid','parent','property','file','trigger','interval','limit','comment'],
								'collector' : ['name','group','property','file','comment']}
