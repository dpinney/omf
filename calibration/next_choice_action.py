...
next_choice_actions[2] = { 2 : 3, 3 : 4, 4 : 7 , 7 : 0 }
...
next_choice_actions[3] = { 3 : 2, 2 : 4, 4 : 7, 7 : 0 }
...
next_choice_actions[4] = { 4 : 3, 3 : 7, 7 : 8, 8 : 0 }

# 1 - 5 : summer peak
# 2 - 6 : summer peak & winter
# 3 - 7 : peaks overall

next_choice_actions[5] = { 5 : 6, 6 : 7, 7 : 0 }
...
next_choice_actions[6] = { 6 : 7, 7 : 5, 5 : 6, 6 : 0 }
